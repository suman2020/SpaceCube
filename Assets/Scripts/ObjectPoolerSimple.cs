...
namespace Keyur.Components.ObjectPooling
{
	public class ObjectPoolerSimple : MonoBehaviour
	{
		...
		public int pooledAmount = 2; //number of clone at start
		public bool isPoolGrow =true; //can pool grow at runtime
		public int maxGrowAmount=30; //maximum number of clone
